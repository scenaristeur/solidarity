...
function init__splash_enterClicked(){$("#div__index_splash_pc").css("display","none")}function div_todolist_add(){alert("add clicked!")}function div_todolist__onClick(a){for(var b=0;b<g.m_todolist._data._items.length;b++)$("#"+g.m_todolist._data._parent+"__item"+b).prop("checked",!1);$("#"+g.m_todolist._data._parent+"__item"+a).prop("checked",!0);g.m_todolist._data._selected=a}function navigation__chatterModeClicked(){}function navigation_tabs_onclick(a){}
function navigation__findOutMore(){openwindow("https://github.com/scenaristeur/solidarity")}
...
"none");$("#div_banner__account__loggedin").css("display","inline");$("#div_inputconsole__loggedin__avatar_container").css("display","inline")}
function solid_login__ShowAsLoggedOut(){$("#div_banner__account__loggedin__name").html("");$("#div_banner__account__loggedin__avatar").css("background-image","url('')");$("#div_banner__account__loggedin").css("display","none");$("#div_banner__account__loggedout").css("display","inline");$("#div_inputconsole__loggedin__avatar_container").css("display","none")}
...
for(var b=0;b<g.active_channel.chat_massages.length;b++){var c=g.active_channel.chat_massages[b];trace(c);if(void 0!=c.maker){var d=Templates.Get("Chatter_Item");"undefined"!=c.makerimg?d=d.searchAndReplace("@AVATAR@",c.makerimg):d=d.searchAndReplace("@AVATAR@","images/no-avatar.png");d=d.searchAndReplace("@AVATAR@",c.makerimg);d=d.searchAndReplace("@LBL_NAME@",c.makername);d=d.searchAndReplace("@LBL_WEBID@",c.maker);d=d.searchAndReplace("@LBL_CONTENT@",c.content);d=d.searchAndReplace("@LBL_TIME@",
0==g.preferences.date_format?jQuery.timeago(new Date(c.date)):moment(new Date(c.date)).add(24,"hours").format("MMM Do YYYY, h:mm a"));a+=d}}$("#div_chatter_container").html("<div style='margin-top:0px'></div>"+a+"<div style='margin-top:25px'></div>");0==g.state.bFirstRunSession?g.state.bFirstRunSession=!0:g.preferences.sounds&&window.sfx_new_chat.play();$(".avatar").popup({inline:!0,hoverable:!0,delay:{show:300,hide:800}});setScrollerToBottom("div_chatter_container")}
function solid_long_chat_reply__onEnterCheck(){return 13===window.event.keyCode?(trace("ENTER Pressed!"),solid_long_chat__sendMessage(),!1):!0}
