...
class ChannelCreateElement extends LitElement {
  ...
  render () {
    ...
    <h6 class="m-0 font-weight-bold text-primary title">New Channel
    <i @click="${() => this.dispatchEvent(new CustomEvent('dialog.cancel'))}"
    class="close fas fa-window-close"></i>
    </h6>
    <div>
    ...
    <button class="btn btn-primary" @click=${this.create}>Create</send>
    </div>
...
customElements.define('channel-create-element', ChannelCreateElement)
