  ...
  firstUpdated(){
    ...
    auth.trackSession(async function(session) {
      if (!session){
        ...
        app.fullname = "Boo"
        app.agent.sendMulti(['Hola', 'Inbox', 'Fab', 'Contacts', 'PostDialog'],  {action:"webIdChanged", webId: app.webId, fullname: app.fullname, img:null});
        ...
        console.log(app.img)
        app.agent.sendMulti(['Hola', 'Inbox', 'Fab', 'Contacts', 'PostDialog'], {action:"webIdChanged", webId: app.webId, fullname: app.fullname, img: app.img});
