...
class InputSimpleElement extends LitElement {
  ...
  render(){
    ...
    <a class="btn btn-primary btn-sm notActive" value="InstantMessage" @click="${this.changePostType}">CHAT</a>
    </div>
    <div class="row text-right">
    <i class="fas fa-check text-success" ?hidden=${this.type != "questions"}></i>
    <a class="btn btn-primary btn-sm notActive" value="Question" @click="${this.changePostType}">QUESTION</a>
    </div>
    <div class="row text-right">
    <i class="fas fa-check text-success" ?hidden=${this.type != "topics"}></i>
    <a class="btn btn-primary btn-sm notActive" value="WikiArticle" @click="${this.changePostType}">TOPIC</a>
    </div>
    <div class="row text-right">
    <i class="fas fa-check text-success" ?hidden=${this.type != "polls"}></i>
    <a class="btn btn-primary btn-sm notActive" value="Poll" @click="${this.changePostType}">POLL</a>
    </div>
